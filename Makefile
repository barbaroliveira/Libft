...
SRCS		= ft_isalnum.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_strlen.c ft_isalpha.c \
		...
		ft_atoi.c ft_calloc.c ft_strdup.c ft_putnbr_fd.c ft_putendl_fd.c ft_putstr_fd.c \
		ft_putchar_fd.c ft_striteri.c ft_strmapi.c ft_itoa.c ft_split.c ft_substr.c \
		ft_strjoin.c ft_strtrim.c ft_putstr.c ft_putchar.c
